  ...
  return (
    <section className="mb-8 overflow-hidden sm:mb-10">
      <div className="mb-3 flex items-end justify-between gap-4 sm:mb-4">
        ...
        <div className="hidden shrink-0 items-center gap-2 md:flex">
          <button
            type="button"
            onClick={() => scroll("left")}
            className="flex size-8 items-center justify-center rounded-full border border-border-default hover:shadow-sm"
      ...
      <div className="overflow-hidden md:hidden">
        <div
          ref={scrollRef}
          className="flex gap-3 overflow-x-auto overscroll-x-contain pb-1 snap-x snap-mandatory scrollbar-hide"
        >
